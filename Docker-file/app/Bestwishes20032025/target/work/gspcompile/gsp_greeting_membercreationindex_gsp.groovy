...
class gsp_greeting_membercreationindex_gsp extends GroovyPage {
...
printHtmlPart(20)
expressionOut.print(createLink(controller:'membercreation', action:'viewimg1', id:usersInstance?.id))
printHtmlPart(19)
expressionOut.print(System.currentTimeMillis())
printHtmlPart(21)
createTagBody(4, {->
printHtmlPart(22)
invokeTag('hiddenField','g',251,['name':("userListid"),'value':(usersInstance?.id)],-1)
printHtmlPart(22)
invokeTag('submitButton','g',252,['name':("edit"),'value':("Edit"),'class':("btn btn-warning")],-1)
printHtmlPart(23)
})
invokeTag('formRemote','g',253,['name':("editUser"),'url':([action:'userEdit']),'update':("update1")],4)
printHtmlPart(24)
...
invokeTag('ifAnyGranted','sec',279,['roles':("ROLE_ADMIN")],2)
printHtmlPart(29)
invokeTag('render','g',302,['template':("/header/footer")],-1)
printHtmlPart(30)
})
invokeTag('captureBody','sitemesh',393,['class':("page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid")],1)
printHtmlPart(31)
}
...
public static final long LAST_MODIFIED = 1744004813595L
